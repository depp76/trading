"""strategy/rebalance/classify.py — Buy/sell/hold classification from ranked candidates (rebalance.md 11-2).
...
rebalance.md 8-A/8-B), so future sector-cap/regime work never needs to touch
this file.
"""
